...
export default function GeminiRecommender() {
  ...
  return (
    <section className="py-24 bg-cacao text-vanilla overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-sm border border-white/10 p-8 md:p-12 rounded-[2rem] shadow-2xl">
          ...
          <p className="text-vanilla/70 mb-10 text-lg font-light">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-white/10 border border-white/20 rounded-2xl py-5 px-6 pr-16 text-vanilla placeholder:text-vanilla/30 focus:outline-none focus:border-gold transition-colors"
            />
            <button
              onClick={getRecommendation}
              disabled={loading}
              className="absolute right-3 top-1/2 -translate-y-1/2 p-3 bg-gold text-cacao rounded-xl hover:bg-gold-light transition-colors disabled:opacity-50"
            >
